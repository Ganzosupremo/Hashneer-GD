...
func _get_ore_resource(ore_type: OreDetails.OreType) -> OreDetails:
        match ore_type:
                OreDetails.OreType.DIRT:
                        return preload("res://Resources/Ores/Dirt.tres")
                OreDetails.OreType.COAL:
                        return preload("res://Resources/Ores/Coal.tres")
                OreDetails.OreType.IRON:
                        return preload("res://Resources/Ores/Iron.tres")
                OreDetails.OreType.COPPER:
                        return preload("res://Resources/Ores/Copper.tres")
                OreDetails.OreType.SILVER:
                        return preload("res://Resources/Ores/Silver.tres")
                OreDetails.OreType.GOLD:
                        return preload("res://Resources/Ores/Gold.tres")
                OreDetails.OreType.DIAMOND:
                        return preload("res://Resources/Ores/Diamond.tres")
                OreDetails.OreType.EMERALD:
                        return preload("res://Resources/Ores/Emerald.tres")
                OreDetails.OreType.BITCOIN_ORE:
                        return preload("res://Resources/Ores/Bitcoin.tres")
                _:
                        return preload("res://Resources/Ores/Dirt.tres")


## Spawn ore pickup when block is destroyed
func _spawn_ore_drop(position: Vector2, ore_type: OreDetails.OreType, ore_data: OreDetails, depth: int) -> void:
