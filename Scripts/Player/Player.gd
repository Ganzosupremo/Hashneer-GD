...
## Applies a brief time slowdown effect (hitstop/freeze frame)
## [param duration]: How long the hitstop lasts in seconds
## [param time_scale]: The time scale to apply (0.0 = full freeze, 1.0 = normal)
func _apply_hitstop(duration: float = 0.08, time_scale: float = 0.15) -> void:
        Engine.time_scale = time_scale
