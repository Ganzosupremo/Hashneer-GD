...
var fracture_body_color: Color = Color.WHITE

var pool_cut_visualizer: PoolFracture
var pool_fracture_shards: PoolFracture
var pool_fracture_bodies: PoolFracture
var rigid_bodies_parent: Node2D

var terrain_block_template: PackedScene

var mining_mode_enabled: bool = false
