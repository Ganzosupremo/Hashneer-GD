...
@export var game_levels: Array[WorldGenArgs]

var _levels_unlocked: int = 1
var _previous_levels_unlocked_index: int = 0
var current_level: int = 0

var _current_level_args: WorldGenArgs = null
var _player: PlayerController = null
var _current_fracture_manager: FractureManager
...
func get_level_args() -> WorldGenArgs:
...
func set_fracture_manager(manager: FractureManager) -> void:
	_current_fracture_manager = manager
...
func get_current_level_args() -> WorldGenArgs:
	return _current_level_args

func get_fracture_manager() -> FractureManager:
	return _current_fracture_manager
